package Interfaces2::DataTable::SQLServer;
...
BEGIN {
	@Interfaces2::DataTable::SQLServer::methods = qw(ReadData WriteData ReConfigureFromDatabase CreateInsertQuery CreateSelectQuery CreateUpdateQuery CreateTable);
}
